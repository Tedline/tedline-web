...
<template>
 <div class="mx-auto max-w-2xl xs:px-6 lg:max-w-7xl lg:px-8">
   <div class="relative isolate my-16 overflow-hidden">
     <!-- Background with enhanced gradient -->
     <div class="absolute inset-0 md:rounded-3xl bg-gradient-to-br from-blue-500 via-blue-600 to-indigo-700 dark:from-indigo-900/80 dark:via-blue-900/70 dark:to-indigo-950/80"></div>
       ...
       <div class="grid grid-cols-1 md:grid-cols-4 gap-8 items-center">
         ...
         <div class="md:col-span-3">
           <UCarousel
             ...
             class="md:px-2 ltr"
             :ui="{
               item: 'basis-2/5 sm:basis-2/4 md:basis-1/5 lg:basis-1/6',
               container: 'gap-0'
             }"
           >
             <template #default="{ item, index }">
               <NuxtLinkLocale
                 ...
                 class="group relative flex flex-col items-center mx-2 gap-3 px-4 py-4 rounded-2xl bg-white/10 dark:bg-black/20 backdrop-blur-md border border-white/20 dark:border-blue-400/0 hover:bg-white/20 dark:hover:bg-white/10 hover:border-white/30 dark:hover:border-white/0  hover:shadow-xl hover:shadow-blue-500/20 transition-all duration-300 min-h-[120px]"
               >
                 ...
                 <!-- Icon -->
                 <div class="relative flex items-center justify-center w-12 h-12 rounded-xl bg-white/20 dark:bg-white/10 group-hover:bg-white/30 dark:group-hover:bg-white/20 backdrop-blur-sm border border-white/30 dark:border-white/20 transition-all duration-300  group-hover:rounded-2xl">
                   <UIcon 
                     :name="item.icon ? item.icon : 'i-heroicons-folder-open'" 
