  ...
  <div class="bg-white dark:bg-zinc-900">
    <div class="relative isolate overflow-hidden bg-gradient-to-b from-zinc-100/20 dark:from-zinc-900/20">
      <div class="mx-auto max-w-7xl pb-24 pt-10 sm:pb-32 lg:grid lg:grid-cols-2 lg:gap-x-8 lg:px-8 lg:pt-40 lg:pb-20">
            ...
            <div class="max-w-lg">
              <div class="mt-24 sm:mt-32 lg:mt-10">
                <a href="#" class="inline-flex space-x-6 rtl:space-x-reverse">
                  ...
                  <span class="inline-flex items-center space-x-2 rtl:space-x-reverse text-sm font-medium leading-6 text-gray-600 dark:text-gray-300">
                    <span>{{ $t('tagline') }}</span>
                  </span>
                </a>
              </div>
              <h1 class="text-4xl mt-9 font-bold text-blue-500 dark:text-blue-300">
                ...
                <span class="relative whitespace-nowrap text-black dark:text-white">
                  <svg aria-hidden="true" viewBox="0 0 418 42"
                    class="absolute left-0 rtl:left-0 ltr:right-0 top-2/3 h-[0.58em] w-full fill-gray-200/70 dark:fill-gray-700/70" preserveAspectRatio="none">
                    <path
              ...
              <div class="mt-10 ">
                ...
                <form class="max-w-md">
                  <label for="default-search"
                    class="mb-2 text-sm font-medium text-gray-900 sr-only dark:text-white">{{ $t('search') }}</label>
                  <div class="relative">
        ...
        <div class="mt-20 sm:mt-24 md:mx-auto md:max-w-xl 2xl:max-w-2xl lg:mx-0 lg:mt-0 lg:w-screen rtl:float-left ltr:float-right">
          <div
            class="absolute inset-y-0 rtl:left-1/2 ltr:right-1/2 -z-10 rtl:-mr-10 ltr:-ml-10 w-[200%] skew-x-[30deg] bg-white shadow-xl shadow-indigo-600/10 ring-1 ring-indigo-50 md:rtl:-ml-20 md:ltr:-mr-20 lg:rtl:-ml-36 lg:ltr:-mr-36 dark:bg-black dark:shadow-zinc-900/10 dark:ring-zinc-900/20"
            aria-hidden="true" />
          <div class="shadow-lg md:rounded-3xl dark:shadow-zinc-900/30">
            <div class="bg-indigo-500 [clip-path:inset(0)] md:[clip-path:inset(0_round_theme(borderRadius.3xl))] dark:bg-indigo-700">
              <div
              ...
              <div class="relative px-6 pt-8 sm:pt-16 md:rtl:pr-16 md:rtl:pl-0 md:ltr:pl-16 md:ltr:pr-0">
                <div class="mx-auto max-w-2xl md:mx-0 md:max-w-none">
                  <div class="w-screen overflow-hidden ltr:rounded-tl-4xl rtl:rounded-tr-4xl bg-gray-100 dark:bg-zinc-800">
                    <div class="px-6 pb-14 pt-6">
                      <!-- Your code example -->
                    </div>
                  </div>
                </div>
                <div class="pointer-events-none absolute inset-0 ring-1 ring-inset ring-black/10 md:rounded-3xl dark:ring-white/10"
                  aria-hidden="true" />
              </div>
            </div>
          </div>
